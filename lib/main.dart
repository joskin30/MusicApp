...
class MyApp extends StatelessWidget {
  final List<Music> listMusic = [
    Music('Sergio Rojas', 'Pecado', 296),
    Music('Blinding Lights', 'The Weeknd', 223),
    Music('Desde El Cielo Al Infierno', 'Javier Díaz', 243),
    Music('Dont Start Now', 'Dua Lipa', 220),
    Music('Ya No Me Importa', 'Sebas Estrada', 329),
    Music('On My Own', 'Lazy Dancer', 232),
    Music('Memories', 'Maroon 5', 245),
    Music('País Sideral', 'Tú No Existes', 193),
    Music('Someone You Loved', 'Lewis Capaldi', 206),
    Music('Nv4.Dll', 'Bondage Fairies', 299),
    Music('Si A Mi Lado Tú Estás', 'Sara Reus', 203),
    Music('Yummy', 'Justin Bieber', 294),
    Music('Despeinada', 'Ozuna, Camilo', 240),
    Music('Quiero Que Te Quedes - Li', 'Kamilo Renteria', 245),
    Music('De Noche Y De Día', 'María Rodríguez', 221),
    Music('Adore You', 'Harry Styles', 239),
  ];
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              blurRadius: 10.0,
              color: Colors.deepOrange[900],//0xFFAE1947),
            ),
          ],
        ),
        child: IconButton(
          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: NetworkImage('https://www.designformusic.com/wp-content/uploads/2018/11/trailer-tension-album-cover-3d-design-1000x1000.jpg'),
                fit: BoxFit.cover,
              ),
            ),
